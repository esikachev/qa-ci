...
sshpass -p $pass ssh $host -l $user ". openrc && openstack image create mapr_5.1.0 --file mitaka/sahara-mitaka-mapr-5.1.0-ubuntu.qcow2 --disk-format qcow2 --container-format bare --property '_sahara_tag_mapr'='True' --property '_sahara_tag_5.1.0.mrv2'='True'  --property '_sahara_username'='ubuntu'"
}
