...
sshpass -p $controller_password ssh $host_master_ip -l $controller_username ssh $local_compute_ip "mount -o remount,rw,nobarrier /dev/mapper/vm-nova /var/lib/nova"
