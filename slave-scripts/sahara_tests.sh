...
case $plugin in
    ambari_2.3)
       ...
       sshpass -p $OS_PASSWORD ssh $host_ssh_user@$controller_ip "nova boot --image mirror --flavor m1.small --security-groups default --nic net-id=2c908c7f-4139-4d25-9a75-daea4ed9b603 mirror &&
